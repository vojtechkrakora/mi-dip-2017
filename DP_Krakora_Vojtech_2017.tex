...
\chapter{Návrh řešení}
	...
	\section{Logování Unify}
		\todo{Více zdůraznit co vlastně navruji.}
		\label{sec:logging_unify}
		Platforma Unify loguje veškerý průběh do souborových audit logů. Protože celá integrace je založena na Javě, je využít logovací framework Log4j \cite{log4j}. Knihovna Log4j umožňuje nastavit si pattern logování \cite{log4jPatternLayout}. Na Unify je použit pattern \todo{Přidat pattern Log4j}. 
	...
	\section{Prezentace dat}
		\todo{Zde budu psát o tom proč Google charts a co to je Google charts.}
		\blind[1]
		
	\section{Využití dát systémy 3. stran}
		\todo{Zde popíši, jak je zaručeno, že data budou moct využívat systémy 3. stran}
		\blind[1]
